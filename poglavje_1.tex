...
\begin{figure}[H]
	...
	\scriptsize
	\begin{tikzpicture}
		\begin{axis}[xlabel={Število zahtev}, ylabel={$t_{zahteva}$ [ms, naraščajoče]}]
...
\begin{figure}[H]
	...
	\scriptsize
	\begin{tikzpicture}
		\begin{axis}[xlabel={Število zahtev}, ylabel={$t_{mreza}$ [ms, naraščajoče]}]
...
\begin{figure}[H]
	...
	\scriptsize
	\begin{tikzpicture}
		\begin{axis}[xlabel={Število zahtev}, ylabel={$\frac{t_{baza}}{t_{streznik}}$ [ms, naraščajoče]}]
...
\scriptsize
	\begin{tikzpicture}
		\begin{axis}[xlabel={Število zahtev}, ylabel={Delež časa [odstotek]}]
...
\scriptsize
	\begin{tikzpicture}
		\begin{axis}[xlabel={Zaporedna številka zahteve}, ylabel={Čas nalaganja 1 slike [ms]}]
