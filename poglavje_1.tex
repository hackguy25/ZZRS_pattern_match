...
\begin{table}[ht]
 \caption{Časi zahtev, poslanih iz različnih lokacij.}
...
Kot izvedbo stresnega testa smo umetno zmanjševali količino delovnega pomnilnika, ki ga je storitev imela na voljo.
...
Začeli smo z vsem pomnilnikom (1 GB), nato pa ga postopoma zmeraj več alocirali v korakih po 100 MB.
...
\scriptsize
	\begin{tikzpicture}[scale=1.1]
		\begin{axis}[xlabel={Količina umetno odvzetega pomnilnika [MB]}, xtick={0,100,...,600}, ymin = 0, ymax = 1000, ylabel={Povprečen čas odgovora [ms]}, ytick={0,100,...,1000}, minor ytick={0,20,...,1000}, grid=major]
			\addplot[mark=none] table{Result_processing/02_05_stresni_test/avgs.dat};
		\end{axis}
	\end{tikzpicture}
\caption{Diagram povprečnih časov odziva glede na količino umetno odvzetega pomnilnika.}
...
\begin{table}[ht]
 \caption{Časi zahtev glede na število sočasnih uporabnikov.}
...
Sklepamo, da smo naleteli na neznano ozko grlo, za natančnejšo določitev regresije bi morali natančneje opazovati obnašanje storitve pri več uporabnikih in določiti, kateri del obdelave povzroči to upočasnitev.
...
Uspeh storitev temelji na več faktorjih.
Vsekakor je zanesljivost infrastrukture zelo pomemben del.
